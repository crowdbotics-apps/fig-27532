...
export class Blank extends React.Component {
  ...
  render = () => (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      ...
      <View style={styles.View_5_800}>
        <Text style={styles.Text_5_800}>
      ...
      <ImageBackground
        ...
        style={styles.ImageBackground_5_801}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_5_802}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_5_803}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_5_804}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_5_805}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_5_806}
      />
      ...
      <View style={styles.View_5_812}>
        <ImageBackground
          ...
          style={styles.ImageBackground_5_813}
        />
        <View style={styles.View_5_814}>
          <ImageBackground
            ...
            style={styles.ImageBackground_5_815}
          />
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_5_816}
          />
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_5_817}
          />
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_5_818}
          />
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_5_819}
          />
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_5_820}
          />
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_5_821}
          />
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_5_822}
          />
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_5_823}
          />
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_5_824}
          />
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_5_825}
          />
          <View style={styles.View_5_826}>
            <View style={styles.View_5_827}>
              <ImageBackground
                ...
                style={styles.ImageBackground_5_828}
              />
                      ...
                      <View style={styles.View_5_835}>
                        <View style={styles.View_5_836}>
                          <View style={styles.View_5_837}>
                            <ImageBackground
                              ...
                              style={styles.ImageBackground_5_838}
                            />
                          </View>
                          <View style={styles.View_5_840}>
                            <ImageBackground
                              ...
                              style={styles.ImageBackground_5_841}
                            />
                          </View>
                          <View style={styles.View_5_843}>
                            <ImageBackground
                              ...
                              style={styles.ImageBackground_5_844}
                            />
                          </View>
                          <View style={styles.View_5_846}>
                            <ImageBackground
                              ...
                              style={styles.ImageBackground_5_847}
                            />
                          </View>
                        </View>
                        <ImageBackground
                          ...
                          style={styles.ImageBackground_5_849}
                        />
                        <ImageBackground
                          source={{
                            uri:
                          ...
                          style={styles.ImageBackground_5_850}
                        />
                        <View style={styles.View_5_851}>
                          <ImageBackground
                            ...
                            style={styles.ImageBackground_5_852}
                          />
                          <ImageBackground
                            source={{
                              uri:
                            ...
                            style={styles.ImageBackground_5_854}
                          />
                          <ImageBackground
                            source={{
                              uri:
                            ...
                            style={styles.ImageBackground_5_856}
                          />
                          <ImageBackground
                            source={{
                              uri:
                            ...
                            style={styles.ImageBackground_5_858}
                          />
                        </View>
                      </View>
                    </View>
            ...
            <View style={styles.View_5_860}>
              <ImageBackground
                ...
                style={styles.ImageBackground_5_861}
              />
              <ImageBackground
                source={{
                  uri:
              ...
              <ImageBackground
                ...
                style={styles.ImageBackground_5_863}
              />
              <ImageBackground
                source={{
                  uri:
                ...
                style={styles.ImageBackground_5_864}
              />
              <ImageBackground
                source={{
                  uri:
                ...
                style={styles.ImageBackground_5_867}
              />
              <ImageBackground
                source={{
                  uri:
                ...
                style={styles.ImageBackground_5_868}
              />
              <ImageBackground
                source={{
                  uri:
                ...
                style={styles.ImageBackground_5_869}
              />
            </View>
          </View>
        </View>
      ...
      <ImageBackground
        ...
        style={styles.ImageBackground_5_872}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_5_873}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_5_874}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_5_875}
      />
    </ScrollView>
  )
}
...
const styles = StyleSheet.create({
  ...
  ImageBackground_5_817: {
    ...
    marginTop: 0,
    position: "absolute",
    left: wp("27.916360016606284%")
  },
  ImageBackground_5_818: {
    ...
    marginTop: 0,
    position: "absolute",
    left: wp("39.387401636096016%")
  },
  ImageBackground_5_819: {
    ...
    marginTop: 0,
    position: "absolute",
    left: wp("18.341506736865938%")
  },
  ImageBackground_5_820: {
  ...
  View_5_837: {
    ...
    marginTop: 0,
    position: "absolute",
    left: wp("1.3725243904740339%")
  },
  ImageBackground_5_838: {
    width: wp("10.565836072543968%"),
    height: hp("6.949596196575894%"),
    top: hp("0%"),
    marginLeft: 0,
  ...
  View_5_843: {
    ...
    marginTop: 0,
    position: "absolute",
    left: wp("2.5692262511322426%")
  },
  ImageBackground_5_844: {
    width: wp("6.6269934465343825%"),
    height: hp("6.630160639194843%"),
    top: hp("0%"),
    marginLeft: 0,
  ...
  ImageBackground_5_849: {
    ...
    marginTop: 0,
    position: "absolute",
    left: wp("0.3946940104166643%")
  },
  ImageBackground_5_850: {
  ...
  View_5_851: {
    ...
    marginTop: 0,
    position: "absolute",
    left: wp("6.128548884737313%")
  },
  ImageBackground_5_852: {
    ...
    marginTop: 0,
    position: "absolute",
    left: wp("2.8947765700483075%")
  },
  ImageBackground_5_854: {
    ...
    marginTop: 0,
    position: "absolute",
    left: wp("1.9962034363677645%")
  },
  ImageBackground_5_856: {
  ...
  ImageBackground_5_863: {
    ...
    marginTop: 0,
    position: "absolute",
    left: wp("16.713253887379224%")
  },
  ImageBackground_5_864: {
  ...
  ImageBackground_5_868: {
    ...
    marginTop: 0,
    position: "absolute",
    left: wp("20.606264860733695%")
  },
  ImageBackground_5_869: {
